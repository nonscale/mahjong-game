...
| # | 스킬 | 설명 |
|---|------|------|
| 1 | `verify-marf-engine` | Numba JIT 및 정합성 검증 (Q/Y 확장) |
| 2 | `verify-data-integrity` | 초장기 시계열 수정주가 무결성 검증 |
| 3 | `verify-quantum-tactics` | 퀀텀 전술 JSON 문법 및 정합성 검증 |
| 4 | `verify-ui-dashboard` | 7분할 대시보드 및 범례 검증 |
| 5 | `yl-to-python-converter` | YL -> Polars 변환 및 단위 검증 |
| 6 | `yl-to-spot-integrator` | YesSpot 데이터 통합 및 규약 검증 |
